#
#  Be sure to run `pod spec lint FNSDK-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  #
   ...
   spec.source       = { :git => "https://github.com/TomandWinnie/FNSDK-iOS.git", :tag => spec.version }
